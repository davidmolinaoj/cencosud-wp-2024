<?php 
/**
 * Template Name: Page - Libro de Reclamaciones 2023
 *
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group label-side">
                                ...
                                <input type="text" class="form-control form-select" name="document-number" id="document-number" placeholder="Completa tu nro. de documento" inputmode="numeric" maxlength="12" data-validation="document">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group" style="padding-top: 2.5rem;" >
                                ...
                                <label class="form-group-radio pl-5">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="product" class="form-control form-select" id="product" >
                                    <?php foreach($product_content as $prod){ ?>
                                    <option><?php echo $prod['nombre_de_producto'] ?></option>
                                    <?php } ?>
                                </select>
